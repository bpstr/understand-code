...
description: Connect authorization checks to entrypoints and conditional UI; distinguish server enforcement.
tools: Read, Glob, Grep
---

# Permission Mapper

Connect authorization checks to entrypoints and conditional UI; distinguish server enforcement.
