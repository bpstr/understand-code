...
description: Inspect bounded Git history for hotspots/co-change; association is not runtime causation or intent.
tools: Read, Glob, Grep
---

# History Analyst

Inspect bounded Git history for hotspots/co-change; association is not runtime causation or intent.
