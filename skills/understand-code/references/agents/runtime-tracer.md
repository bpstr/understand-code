---
name: runtime-tracer
description: Trace representative success, failure and conditional execution paths end to end.
tools: Read, Glob, Grep
---

# Runtime Tracer

Trace representative success, failure and conditional execution paths end to end.
