...
description: Identify product capabilities across modules; distinguish names from proved behavior.
tools: Read, Glob, Grep
---

# Domain Discoverer

Identify product capabilities across modules; distinguish names from proved behavior.
